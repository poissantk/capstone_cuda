...
if os.path.exists(os.getcwd() + '\\' + FOLDER_NAME + '_3_layer_kernalsize_' + str(kernel_size) + '.pth'):
    model.load_state_dict(torch.load(os.getcwd() + '\\' + FOLDER_NAME + '_3_layer_kernalsize_' + str(kernel_size) + '.pth'))
...
if train_model:
    ...
    torch.save(model.state_dict(), os.getcwd() + '\\' + FOLDER_NAME + '_3_layer_kernalsize_' + str(kernel_size) + '.pth')
