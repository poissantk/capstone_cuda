...
paths = ["photos_split_by_day\\6\\string1",
         "photos_split_by_day\\6\\string2",
         "photos_split_by_day\\6\\string3",
         "photos_split_by_day\\6\\string4",
         "photos_split_by_day\\6\\string5",
         "photos_split_by_day\\6\\string6",
         "photos_split_by_day\\6\\no_string"]
    ...
    for dirs in dirss:
        ...
        for item in dirs:
            ...
            if os.path.isfile(fullpath):
                ...
                left = 650 + left_right_shift
                right = 1250 + left_right_shift

                top_bottom_shift = random.randint(-50, 50)
                top = 550 + top_bottom_shift
                bottom = 900 + top_bottom_shift

                f, e = os.path.splitext(fullpath)
                imCrop = im.crop((left, top, right, bottom))
                fullpath = os.path.join("photos_split_by_day_cropped//6", paths[path_index].split("\\")[-1], item)
