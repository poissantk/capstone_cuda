...
paths = ["photos_split_by_day\\2\\string1",
         "photos_split_by_day\\2\\string2",
         "photos_split_by_day\\2\\string3",
         "photos_split_by_day\\2\\string4",
         "photos_split_by_day\\2\\string5",
         "photos_split_by_day\\2\\string6",
         "photos_split_by_day\\2\\no_string"]
    ...
    for dirs in dirss:
        ...
        for item in dirs:
            ...
            if os.path.isfile(fullpath):
                ...
                fullpath = os.path.join("photos_split_by_day_cropped//2", paths[path_index].split("\\")[-1], item)
