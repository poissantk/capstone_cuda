...
paths = ["photos_split_by_day\\7\\string1",
         "photos_split_by_day\\7\\string2",
         "photos_split_by_day\\7\\string3",
         "photos_split_by_day\\7\\string4",
         "photos_split_by_day\\7\\string5",
         "photos_split_by_day\\7\\string6",
         "photos_split_by_day\\7\\no_string"]
    ...
    for dirs in dirss:
        ...
        for item in dirs:
            ...
            if os.path.isfile(fullpath):
                ...
                fullpath = os.path.join("photos_split_by_day_cropped//7", paths[path_index].split("\\")[-1], item)
