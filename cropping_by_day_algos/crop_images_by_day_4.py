...
paths = ["photos_split_by_day\\4\\string1",
         "photos_split_by_day\\4\\string2",
         "photos_split_by_day\\4\\string3",
         "photos_split_by_day\\4\\string4",
         "photos_split_by_day\\4\\string5",
         "photos_split_by_day\\4\\string6",
         "photos_split_by_day\\4\\no_string"]
    ...
    for dirs in dirss:
        ...
        for item in dirs:
            ...
            if os.path.isfile(fullpath):
                ...
                top = 400 + top_bottom_shift
                bottom = 750 + top_bottom_shift

                f, e = os.path.splitext(fullpath)
                imCrop = im.crop((left, top, right, bottom))
                fullpath = os.path.join("photos_split_by_day_cropped//4", paths[path_index].split("\\")[-1], item)
