...
paths = ["photos_split_by_day\\3\\string1",
         "photos_split_by_day\\3\\string2",
         "photos_split_by_day\\3\\string3",
         "photos_split_by_day\\3\\string4",
         "photos_split_by_day\\3\\string5",
         "photos_split_by_day\\3\\string6",
         "photos_split_by_day\\3\\no_string"]
    ...
    for dirs in dirss:
        ...
        for item in dirs:
            ...
            if os.path.isfile(fullpath):
                ...
                top = 450 + top_bottom_shift
                bottom = 800 + top_bottom_shift

                f, e = os.path.splitext(fullpath)
                imCrop = im.crop((left, top, right, bottom))
                fullpath = os.path.join("photos_split_by_day_cropped//3", paths[path_index].split("\\")[-1], item)
